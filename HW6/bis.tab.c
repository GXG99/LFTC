...
{
  "$end", "error", "$undefined", "ID", "SEP", "OP", "KEY", "CONST",
  "$accept", "prog", "statements", "statement", 0
};
#endif
...
{
       4,     9,     5,     3,    -4,     4,    -3,    11,     6,    -4,
      -4,    12,     8,    -4,    14,    -2,    -4,    -1,    -4,    15,
      16,    17,    18,    -4,    -4,    -4,    -4
};
...
{
      11,    19,    21,     9,    12,    20,    22,     1,     7,    14,
       2,     8,    16,    17,     6,    13,     0,    15,    18,    23,
      24,    25,    26,     0,    10
};
...
{
       0,     3,     6,     9,    10,    11,     5,     3,     6,     0,
      10,     3,     7,     4,     3,     5,     4,     5,     4,     3,
       7,     3,     7,     4,     4,     4,     4
};
...
#line 44 "bis.y"
    {
    if (strcmp((yyvsp[(1) - (4)].id), "cout") == 0 && strcmp((yyvsp[(2) - (4)].id), "<<") == 0) {
        char *temp = (char *)malloc(sizeof(char) * 300);
        sprintf(temp, "\t;Printing variable\n\t\tmov eax, [%s]\n\t\tpush dword eax\n\t\tpush dword format\n\t\tcall [printf]\n\t\tadd esp, 4 * 2\n", (yyvsp[(3) - (4)].id));
        strcat(codeSegment, temp);
        free(temp);
    }
    if (strcmp((yyvsp[(1) - (4)].id), "cin") == 0 && strcmp((yyvsp[(2) - (4)].id), ">>") == 0) {
        char *temp = (char *)malloc(sizeof(char) * 300);
...
#line 68 "bis.y"
    {
    if (strcmp((yyvsp[(4) - (6)].id), "+") == 0) {
        char *temp = (char *)malloc(sizeof(char) * 300);
        sprintf(temp, "\t;Adding\n\t\tmov AX, %s\n\t\tmov BX, %s\n\t\tadd AX, BX\n\t\tmov [%s], AX\n", (yyvsp[(3) - (6)].id), (yyvsp[(5) - (6)].id), (yyvsp[(1) - (6)].id));
        strcat(codeSegment, temp);
        free(temp);
    }
    if (strcmp((yyvsp[(4) - (6)].id), "-") == 0) {
